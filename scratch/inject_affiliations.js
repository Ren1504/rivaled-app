...
const affiliations = {
  ...
  "Angela": ["Guardians of the Galaxy", "League of Realms"],
  "Black Cat": ["Heroes for Hire", "Defenders"],
  "Black Panther": ["Avengers", "Illuminati", "Defenders"],
...
// 1. Update the interface Hero definition if needed
...
const heroesArray = eval(arrayText);
...
console.log("Successfully updated affiliations in marvelRivalsData.ts");
